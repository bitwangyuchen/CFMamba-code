...
from utils import cv_imwrite,image_normalization,omsiv_srf_ircut,omsiv_srf_irpass
...
class TestDataset(Dataset):
    ...
    def __init__(self, data_root, arg=True):
        ...
        self.test_list = os.path.join(os.path.dirname(__file__), "data/split_txt/show_list_omsiv.txt")
